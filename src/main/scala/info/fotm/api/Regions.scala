...
case object Europe extends Region("eu.api.battle.net") {
...
case object Korea extends Region("kr.api.battle.net") {
  case object KoKR extends Locale[Korea.type]("ko_KR")
}

case object Taiwan extends Region("tw.api.battle.net") {
  case object ZhTW extends Locale[Korea.type]("zh_TW")
}

case object China extends Region("api.battlenet.com.cn") {
